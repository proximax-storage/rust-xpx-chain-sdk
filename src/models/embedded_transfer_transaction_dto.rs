...
pub struct EmbeddedTransferTransactionDto {
    ...
    /// The array of mosaics sent to the recipient. If the most significant bit of byte 0 is set, a namespace_id (alias) is used instead of a instead of a mosaic_id corresponds to a mosaic_id.
