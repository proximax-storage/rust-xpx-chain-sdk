...
use crate::models::mosaic::{MosaicId, MosaicNonce, MosaicProperties, SUPPLY_MUTABLE, TRANSFERABLE, MosaicSupplyType};
...
impl Transaction for MosaicSupplyChangeTransaction {
    ...
    fn generate_bytes<'a>(&self) -> Vec<u8> {
        ...
        txn_builder.add_direction(self.supply_type.value());
