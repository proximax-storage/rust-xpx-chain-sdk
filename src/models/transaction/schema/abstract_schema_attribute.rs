...
impl AbstractSchemaAttribute {
    ...
    pub(super) fn find_object_start_position(
        &mut self,
        inner_object_position: usize,
        position: usize,
        buffer: &[u8],
    ...
    pub(super) fn find_array_length(
        &mut self,
        inner_object_position: usize,
        position: usize,
        buffer: &[u8],
    ...
    pub(super) fn find_object_array_element_start_position(
        &mut self,
        inner_object_position: usize,
        position: usize,
        buffer: &[u8],
