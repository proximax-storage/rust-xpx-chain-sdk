...
pub mod mosaic_definition {
    ...
    impl<'a> MosaicProperty<'a> {
        ...
        ) -> fb::WIPOffset<MosaicProperty<'bldr>> {
        ...
        pub fn mosaic_property_id(&self) -> u8 {
            self._tab
                .get::<u8>(MosaicProperty::VT_MOSAICPROPERTYID, Some(0))
                .unwrap()
        }
        #[inline]
        pub fn value(&self) -> Option<fb::Vector<'a, u32>> {
            self._tab
                .get::<fb::ForwardsUOffset<fb::Vector<'a, u32>>>(MosaicProperty::VT_VALUE, None)
        }
    }
    ...
    impl<'a: 'b, 'b> MosaicPropertyBuilder<'a, 'b> {
        ...
        pub fn add_mosaic_property_id(&mut self, mosaic_property_id: u8) {
            self.fbb_
                .push_slot::<u8>(MosaicProperty::VT_MOSAICPROPERTYID, mosaic_property_id, 0);
        }
        #[inline]
        pub fn add_value(&mut self, value: fb::WIPOffset<fb::Vector<'b, u32>>) {
            self.fbb_
                .push_slot_always::<fb::WIPOffset<_>>(MosaicProperty::VT_VALUE, value);
        }
        #[inline]
    ...
    impl<'a> MosaicDefinitionTransactionBuffer<'a> {
        ...
        ) -> fb::WIPOffset<MosaicDefinitionTransactionBuffer<'bldr>> {
        ...
        pub fn max_fee(&self) -> Option<fb::Vector<'a, u32>> {
            self._tab.get::<fb::ForwardsUOffset<fb::Vector<'a, u32>>>(
                MosaicDefinitionTransactionBuffer::VT_MAXFEE,
                None,
            )
        }
        #[inline]
        ...
        pub fn mosaic_nonce(&self) -> u32 {
            self._tab
                .get::<u32>(MosaicDefinitionTransactionBuffer::VT_MOSAICNONCE, Some(0))
                .unwrap()
        }
        #[inline]
        pub fn mosaic_id(&self) -> Option<fb::Vector<'a, u32>> {
            self._tab.get::<fb::ForwardsUOffset<fb::Vector<'a, u32>>>(
                MosaicDefinitionTransactionBuffer::VT_MOSAICID,
                None,
            )
        }
        #[inline]
        pub fn num_optional_properties(&self) -> u8 {
            self._tab
                .get::<u8>(
                    MosaicDefinitionTransactionBuffer::VT_NUMOPTIONALPROPERTIES,
                    Some(0),
                )
                .unwrap()
        }
        ...
        pub fn optional_properties(
            &self,
        ) -> Option<fb::Vector<'a, fb::ForwardsUOffset<MosaicProperty<'a>>>> {
            self._tab
                .get::<fb::ForwardsUOffset<fb::Vector<fb::ForwardsUOffset<MosaicProperty<'a>>>>>(
                    MosaicDefinitionTransactionBuffer::VT_OPTIONALPROPERTIES,
                    None,
                )
        }
    }
    ...
    impl<'a: 'b, 'b> MosaicDefinitionTransactionBufferBuilder<'a, 'b> {
        ...
        pub fn add_mosaic_nonce(&mut self, mosaic_nonce: u32) {
            self.fbb_.push_slot::<u32>(
                MosaicDefinitionTransactionBuffer::VT_MOSAICNONCE,
                mosaic_nonce,
                0,
            );
        }
        ...
        pub fn add_flags(&mut self, flags: u8) {
            self.fbb_
                .push_slot::<u8>(MosaicDefinitionTransactionBuffer::VT_FLAGS, flags, 0);
        }
        #[inline]
        ...
        pub fn add_optional_properties(
            &mut self,
            optional_properties: fb::WIPOffset<
                fb::Vector<'b, fb::ForwardsUOffset<MosaicProperty<'b>>>,
            >,
        ) {
            self.fbb_.push_slot_always::<fb::WIPOffset<_>>(
                MosaicDefinitionTransactionBuffer::VT_OPTIONALPROPERTIES,
    ...
    #[inline]
    pub fn get_root_as_mosaic_definition_transaction_buffer<'a>(
        buf: &'a [u8],
    ) -> MosaicDefinitionTransactionBuffer<'a> {
        fb::get_root::<MosaicDefinitionTransactionBuffer<'a>>(buf)
    }

    #[inline]
    pub fn get_size_prefixed_root_as_mosaic_definition_transaction_buffer<'a>(
        buf: &'a [u8],
    ) -> MosaicDefinitionTransactionBuffer<'a> {
