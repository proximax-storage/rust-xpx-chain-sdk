...
pub mod mosaic_supply_change {
    ...
    impl<'a> MosaicSupplyChangeTransactionBuffer<'a> {
        ...
        ) -> fb::WIPOffset<MosaicSupplyChangeTransactionBuffer<'bldr>> {
        ...
        pub fn max_fee(&self) -> Option<fb::Vector<'a, u32>> {
            self._tab.get::<fb::ForwardsUOffset<fb::Vector<'a, u32>>>(
                MosaicSupplyChangeTransactionBuffer::VT_MAXFEE,
                None,
            )
        }
        #[inline]
        ...
        pub fn mosaic_id(&self) -> Option<fb::Vector<'a, u32>> {
            self._tab.get::<fb::ForwardsUOffset<fb::Vector<'a, u32>>>(
                MosaicSupplyChangeTransactionBuffer::VT_MOSAICID,
                None,
            )
        }
        #[inline]
    ...
    impl<'a: 'b, 'b> MosaicSupplyChangeTransactionBufferBuilder<'a, 'b> {
        ...
        pub fn add_direction(&mut self, direction: u8) {
            self.fbb_.push_slot::<u8>(
                MosaicSupplyChangeTransactionBuffer::VT_DIRECTION,
                direction,
                0,
            );
        }
    ...
    #[inline]
    pub fn get_root_as_mosaic_supply_change_transaction_buffer<'a>(
        buf: &'a [u8],
    ) -> MosaicSupplyChangeTransactionBuffer<'a> {
        fb::get_root::<MosaicSupplyChangeTransactionBuffer<'a>>(buf)
    }

    #[inline]
    pub fn get_size_prefixed_root_as_mosaic_supply_change_transaction_buffer<'a>(
        buf: &'a [u8],
    ) -> MosaicSupplyChangeTransactionBuffer<'a> {
