    ...
    pub mod buffers {
        ...
        impl<'a: 'b, 'b> MosaicSupplyChangeTransactionBufferBuilder<'a, 'b> {
            ...
            pub fn add_maxFee(&mut self, maxFee: flatbuffers::WIPOffset<flatbuffers::Vector<'b, u32>>) {
                self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MosaicSupplyChangeTransactionBuffer::VT_MAXFEE, maxFee);
            }
            #[inline]
            ...
            pub fn add_mosaicId(&mut self, mosaicId: flatbuffers::WIPOffset<flatbuffers::Vector<'b, u32>>) {
                self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MosaicSupplyChangeTransactionBuffer::VT_MOSAICID, mosaicId);
            }
            #[inline]
