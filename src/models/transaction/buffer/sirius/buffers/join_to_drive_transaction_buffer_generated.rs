...
impl<'a> JoinToDriveTransactionBuffer<'a> {
    ...
    ) -> flatbuffers::WIPOffset<JoinToDriveTransactionBuffer<'bldr>> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u32>>>(
                    JoinToDriveTransactionBuffer::VT_MAX_FEE,
                    None,
                )
        }
    }
...
impl flatbuffers::Verifiable for JoinToDriveTransactionBuffer<'_> {
    #[inline]
    fn run_verifier(
...
impl core::fmt::Debug for JoinToDriveTransactionBuffer<'_> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        let mut ds = f.debug_struct("JoinToDriveTransactionBuffer");
