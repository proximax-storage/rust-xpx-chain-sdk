...
impl<'a> EndDriveTransactionBuffer<'a> {
    ...
    ) -> flatbuffers::WIPOffset<EndDriveTransactionBuffer<'bldr>> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u32>>>(
                    EndDriveTransactionBuffer::VT_MAX_FEE,
                    None,
                )
        }
    }
...
impl flatbuffers::Verifiable for EndDriveTransactionBuffer<'_> {
    #[inline]
    fn run_verifier(
...
impl core::fmt::Debug for EndDriveTransactionBuffer<'_> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        let mut ds = f.debug_struct("EndDriveTransactionBuffer");
