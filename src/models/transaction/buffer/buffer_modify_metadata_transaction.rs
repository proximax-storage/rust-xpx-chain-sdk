    ...
    pub mod buffers {
        ...
        impl<'a> MetadataModificationBuffer<'a> {
            ...
            pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
                ...
                if let Some(x) = args.valueSize {
                    builder.add_valueSize(x);
                }
        ...
        impl<'a: 'b, 'b> MetadataModificationBufferBuilder<'a, 'b> {
            ...
            pub fn add_keySize(&mut self, keySize: u8) {
                self.fbb_
                    .push_slot::<u8>(MetadataModificationBuffer::VT_KEYSIZE, keySize, 0);
            }
            #[inline]
        ...
        impl<'a> ModifyMetadataTransactionBuffer<'a> {
            ...
            pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
                ...
                if let Some(x) = args.metadataId {
                    builder.add_metadataId(x);
                }
