...
pub mod alias {
    ...
    impl<'a> AliasTransactionBuffer<'a> {
        ...
        ) -> fb::WIPOffset<AliasTransactionBuffer<'bldr>> {
        ...
        pub fn size_(&self) -> u32 {
            self._tab
                .get::<u32>(AliasTransactionBuffer::VT_SIZE_, Some(0))
                .unwrap()
        }
        #[inline]
        ...
        pub fn version(&self) -> u32 {
            self._tab
                .get::<u32>(AliasTransactionBuffer::VT_VERSION, Some(0))
                .unwrap()
        }
        #[inline]
        pub fn type_(&self) -> u16 {
            self._tab
                .get::<u16>(AliasTransactionBuffer::VT_TYPE_, Some(0))
                .unwrap()
        }
        #[inline]
        pub fn max_fee(&self) -> Option<fb::Vector<'a, u32>> {
            self._tab.get::<fb::ForwardsUOffset<fb::Vector<'a, u32>>>(
                AliasTransactionBuffer::VT_MAXFEE,
                None,
            )
        }
        #[inline]
        ...
        pub fn action_type(&self) -> u8 {
            self._tab
                .get::<u8>(AliasTransactionBuffer::VT_ACTIONTYPE, Some(0))
                .unwrap()
        }
        #[inline]
        pub fn namespace_id(&self) -> Option<fb::Vector<'a, u32>> {
            self._tab.get::<fb::ForwardsUOffset<fb::Vector<'a, u32>>>(
                AliasTransactionBuffer::VT_NAMESPACEID,
                None,
            )
        }
        ...
        pub fn alias_id(&self) -> Option<&'a [u8]> {
            self._tab
                .get::<fb::ForwardsUOffset<fb::Vector<'a, u8>>>(
                    AliasTransactionBuffer::VT_ALIASID,
                    None,
                )
                .map(|v| v.safe_slice())
        }
    ...
    impl<'a: 'b, 'b> AliasTransactionBufferBuilder<'a, 'b> {
        ...
        pub fn add_size_(&mut self, size_: u32) {
            self.fbb_
                .push_slot::<u32>(AliasTransactionBuffer::VT_SIZE_, size_, 0);
        }
        #[inline]
        ...
        pub fn add_signer(&mut self, signer: fb::WIPOffset<fb::Vector<'b, u8>>) {
            self.fbb_
                .push_slot_always::<fb::WIPOffset<_>>(AliasTransactionBuffer::VT_SIGNER, signer);
        }
        #[inline]
        pub fn add_version(&mut self, version: u32) {
            self.fbb_
                .push_slot::<u32>(AliasTransactionBuffer::VT_VERSION, version, 0);
        }
        #[inline]
        pub fn add_type_(&mut self, type_: u16) {
            self.fbb_
                .push_slot::<u16>(AliasTransactionBuffer::VT_TYPE_, type_, 0);
        }
        #[inline]
        pub fn add_max_fee(&mut self, max_fee: fb::WIPOffset<fb::Vector<'b, u32>>) {
            self.fbb_
                .push_slot_always::<fb::WIPOffset<_>>(AliasTransactionBuffer::VT_MAXFEE, max_fee);
        }
        #[inline]
        ...
        pub fn add_action_type(&mut self, action_type: u8) {
            self.fbb_
                .push_slot::<u8>(AliasTransactionBuffer::VT_ACTIONTYPE, action_type, 0);
        }
        #[inline]
        ...
        pub fn add_alias_id(&mut self, alias_id: fb::WIPOffset<fb::Vector<'b, u8>>) {
            self.fbb_
                .push_slot_always::<fb::WIPOffset<_>>(AliasTransactionBuffer::VT_ALIASID, alias_id);
        }
        #[inline]
        pub fn new(
    ...
    #[inline]
    pub fn get_size_prefixed_root_as_alias_transaction_buffer<'a>(
        buf: &'a [u8],
    ) -> AliasTransactionBuffer<'a> {
