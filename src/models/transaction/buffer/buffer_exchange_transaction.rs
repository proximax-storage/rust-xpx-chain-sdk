...
pub mod catapult {
    ...
    pub mod buffers {
        ...
        pub struct AddExchangeOfferTransactionBufferArgs<'a> {
            ...
            pub offersCount: u8,
            pub offers: Option<
                fb::WIPOffset<fb::Vector<'a, fb::ForwardsUOffset<AddExchangeOfferBuffer<'a>>>>,
            >,
        }
        ...
        impl<'a: 'b, 'b> AddExchangeOfferTransactionBufferBuilder<'a, 'b> {
            ...
            pub fn add_version(&mut self, version: i32) {
                self.fbb_.push_slot::<u32>(
                    AddExchangeOfferTransactionBuffer::VT_VERSION,
                    version,
                    0,
                );
            }
            ...
            pub fn add_offers(
                &mut self,
                offers: fb::WIPOffset<
                    fb::Vector<'b, fb::ForwardsUOffset<AddExchangeOfferBuffer<'b>>>,
                >,
            ) {
                self.fbb_.push_slot_always::<fb::WIPOffset<_>>(
        ...
        impl<'a: 'b, 'b> RemoveExchangeOfferTransactionBufferBuilder<'a, 'b> {
            ...
            pub fn add_size_(&mut self, size_: u32) {
                self.fbb_.push_slot::<u32>(
                    RemoveExchangeOfferTransactionBuffer::VT_SIZE_,
                    size_,
                    0,
                );
            }
            ...
            pub fn add_type_(&mut self, type_: u16) {
                self.fbb_.push_slot::<u16>(
                    RemoveExchangeOfferTransactionBuffer::VT_TYPE_,
                    type_,
                    0,
                );
            }
