...
pub mod register_namespace {
    ...
    impl<'a> RegisterNamespaceTransactionBuffer<'a> {
        ...
        ) -> fb::WIPOffset<RegisterNamespaceTransactionBuffer<'bldr>> {
        ...
        pub fn max_fee(&self) -> Option<fb::Vector<'a, u32>> {
            self._tab.get::<fb::ForwardsUOffset<fb::Vector<'a, u32>>>(
                RegisterNamespaceTransactionBuffer::VT_MAXFEE,
                None,
            )
        }
        #[inline]
        ...
        pub fn namespace_type(&self) -> u8 {
            self._tab
                .get::<u8>(
                    RegisterNamespaceTransactionBuffer::VT_NAMESPACETYPE,
                    Some(0),
                )
                .unwrap()
        }
        ...
        pub fn duration_parent_id(&self) -> Option<fb::Vector<'a, u32>> {
            self._tab.get::<fb::ForwardsUOffset<fb::Vector<'a, u32>>>(
                RegisterNamespaceTransactionBuffer::VT_DURATIONPARENTID,
                None,
            )
        }
        #[inline]
        pub fn namespace_id(&self) -> Option<fb::Vector<'a, u32>> {
            self._tab.get::<fb::ForwardsUOffset<fb::Vector<'a, u32>>>(
                RegisterNamespaceTransactionBuffer::VT_NAMESPACEID,
                None,
            )
        }
        #[inline]
        pub fn namespace_name_size(&self) -> u8 {
            self._tab
                .get::<u8>(
                    RegisterNamespaceTransactionBuffer::VT_NAMESPACENAMESIZE,
                    Some(0),
                )
                .unwrap()
        }
        ...
        pub fn namespace_name(&self) -> Option<&'a str> {
            self._tab.get::<fb::ForwardsUOffset<&str>>(
                RegisterNamespaceTransactionBuffer::VT_NAMESPACENAME,
                None,
            )
        }
    }
    ...
    impl<'a: 'b, 'b> RegisterNamespaceTransactionBufferBuilder<'a, 'b> {
        ...
        pub fn add_duration_parent_id(
            &mut self,
            duration_parent_id: fb::WIPOffset<fb::Vector<'b, u32>>,
        ) {
            self.fbb_.push_slot_always::<fb::WIPOffset<_>>(
                RegisterNamespaceTransactionBuffer::VT_DURATIONPARENTID,
                duration_parent_id,
    ...
    #[inline]
    pub fn get_root_as_register_namespace_transaction_buffer<'a>(
        buf: &'a [u8],
    ) -> RegisterNamespaceTransactionBuffer<'a> {
        fb::get_root::<RegisterNamespaceTransactionBuffer<'a>>(buf)
    }

    #[inline]
    pub fn get_size_prefixed_root_as_register_namespace_transaction_buffer<'a>(
        buf: &'a [u8],
    ) -> RegisterNamespaceTransactionBuffer<'a> {
