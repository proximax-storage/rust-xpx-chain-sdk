...
pub const ACCOUNT_PROPERTIES_ENTITY_MODIFICATION_SIZE: usize =
    PROPERTY_MODIFICATION_TYPE_SIZE + TYPE_SIZE;
pub const ACCOUNT_PROPERTY_ENTITY_TYPE_HEADER: usize = TRANSACTION_HEADER_SIZE + PROPERTY_TYPE_SIZE;
pub const ACCOUNT_PROPERTIES_MOSAIC_MODIFICATION_SIZE: usize =
...
pub const ADDRESS_SIZE: usize = Address::LENGTH_IN_DECODED;
...
pub const ALIAS_TRANSACTION_HEADER: usize =
    TRANSACTION_HEADER_SIZE + NAMESPACE_SIZE + ALIAS_ACTION_SIZE;
...
pub const LOCK_SIZE: usize =
    TRANSACTION_HEADER_SIZE + MOSAIC_ID_SIZE + AMOUNT_SIZE + DURATION_SIZE + HASH256;
...
pub const MODIFY_MULTISIG_HEADER_SIZE: usize =
    TRANSACTION_HEADER_SIZE + MIN_APPROVAL_SIZE + MIN_REMOVAL_SIZE + MODIFICATIONS_SIZE_SIZE;
pub const MOSAICS_SIZE: usize = BASE_INT64SIZE;
pub const MOSAICS_SIZE_SIZE: usize = 1;

pub const MOSAIC_DEFINITION_TRANSACTION_HEADER_SIZE: usize =
    TRANSACTION_HEADER_SIZE + MOSAIC_NONCE_SIZE + MOSAIC_ID_SIZE + MOSAIC_PROPERTIES_HEADER_SIZE;
...
pub const MOSAIC_SUPPLY_CHANGE_TRANSACTION_SIZE: usize =
    TRANSACTION_HEADER_SIZE + MOSAIC_ID_SIZE + AMOUNT_SIZE + MOSAIC_SUPPLY_DIRECTION_SIZE;
...
pub const PUBLIC_KEY_BYTES_SIZE: usize = 32;
pub const PROPERTY_MODIFICATION_TYPE_SIZE: usize = 1;
pub const PROPERTY_TYPE_SIZE: usize = 2;
pub const REGISTER_NAMESPACE_HEADER_SIZE: usize = TRANSACTION_HEADER_SIZE
    + NAMESPACE_TYPE_SIZE
    + DURATION_SIZE
    + NAMESPACE_SIZE
...
pub const TRANSACTION_HEADER_SIZE: usize = SIZE_SIZE
    ...
    + MAX_FEE_SIZE
    + DEAD_LINE_SIZE;
pub const TRANSFER_HEADER_SIZE: usize =
    TRANSACTION_HEADER_SIZE + ADDRESS_SIZE + MOSAICS_SIZE_SIZE + MESSAGE_SIZE_SIZE;
...
pub const ADD_EXCHANGE_OFFER_SIZE: usize =
    MOSAIC_ID_SIZE + DURATION_SIZE + 2 * AMOUNT_SIZE + OFFER_TYPE_SIZE;
...
pub const METADATA_V2_HEADER_SIZE: usize =
    TRANSACTION_HEADER_SIZE + KEY_SIZE + BASE_INT64SIZE + 2 + 2;
...
//pub const PRIVATE_KEY_BYTES_SIZE: usize = 32;
