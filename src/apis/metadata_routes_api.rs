...
pub trait MetadataRoutesApi {
    fn get_account_metadata(&self, account_id: &str) -> Box<dyn Future<Item = crate::models::AddressMetadataInfoDto, Error = Error<serde_json::Value>>>;
    fn get_metadata(&self, metadata_id: &str) -> Box<dyn Future<Item = crate::models::NamespaceMetadataInfoDto, Error = Error<serde_json::Value>>>;
    fn get_metadatas(&self, metadata_ids: Option<crate::models::MetadataIds>) -> Box<dyn Future<Item = Vec<crate::models::AddressMetadataInfoDto>, Error = Error<serde_json::Value>>>;
    fn get_mosaic_metadata(&self, mosaic_id: &str) -> Box<dyn Future<Item = crate::models::MosaicMetadataInfoDto, Error = Error<serde_json::Value>>>;
    fn get_namespace_metadata(&self, namespace_id: &str) -> Box<dyn Future<Item = crate::models::NamespaceMetadataInfoDto, Error = Error<serde_json::Value>>>;
}
