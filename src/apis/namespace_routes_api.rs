...
pub trait NamespaceRoutesApi {
    fn get_namespace(&self, namespace_id: &str) -> Box<dyn Future<Item = crate::models::NamespaceInfoDto, Error = Error<serde_json::Value>>>;
    fn get_namespaces_from_account(&self, account_id: &str, page_size: Option<i32>, id: Option<&str>) -> Box<dyn Future<Item = Vec<crate::models::NamespaceInfoDto>, Error = Error<serde_json::Value>>>;
    fn get_namespaces_from_accounts(&self, account_ids: crate::models::AccountIds, page_size: Option<i32>, id: Option<&str>) -> Box<dyn Future<Item = Vec<crate::models::NamespaceInfoDto>, Error = Error<serde_json::Value>>>;
    fn get_namespaces_names(&self, namespace_ids: crate::models::NamespaceIds) -> Box<dyn Future<Item = Vec<crate::models::NamespaceNameDto>, Error = Error<serde_json::Value>>>;
}
