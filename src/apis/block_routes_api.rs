...
//
//pub struct BlockRoutesApiClient<C: hyper::client::connect::Connect> {
//    configuration: Rc<configuration::Configuration<C>>,
//}
//
//impl<C: hyper::client::connect::Connect> BlockRoutesApiClient<C> {
...
//}
//
//impl<C: hyper::client::connect::Connect> BlockRoutesApi for BlockRoutesApiClient<C> {
//    fn get_block_by_height(&self, height: i64) -> Box<dyn Future<Item=crate::models::blockchain::BlockInfoDto, Error=Error<serde_json::Value>>> {
