...
pub trait MosaicRoutesApi {
    fn get_mosaic(&self, mosaic_id: &str) -> Box<dyn Future<Item = crate::models::MosaicInfoDto, Error = Error<serde_json::Value>>>;
    fn get_mosaics(&self, mosaic_ids: crate::models::MosaicIds) -> Box<dyn Future<Item = Vec<crate::models::MosaicInfoDto>, Error = Error<serde_json::Value>>>;
    fn get_mosaics_names(&self, mosaic_ids: crate::models::MosaicIds) -> Box<dyn Future<Item = Vec<crate::models::MosaicNamesDto>, Error = Error<serde_json::Value>>>;
}
