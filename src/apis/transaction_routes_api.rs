...
pub trait TransactionRoutesApi {
    fn announce_cosignature_transaction(&self, cosignature: crate::models::Cosignature) -> Box<dyn Future<Item = crate::models::AnnounceTransactionInfoDto, Error = Error<serde_json::Value>>>;
    ...
    fn announce_transaction(&self, transaction_payload: crate::models::TransactionPayload) -> Box<dyn Future<Item = crate::models::AnnounceTransactionInfoDto, Error = Error<serde_json::Value>>>;
