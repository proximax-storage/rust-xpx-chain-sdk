...
use xpx_chain_sdk::transaction::{AggregateTransaction, Deadline, Transaction, ModifyMultisigAccountTransaction};
use xpx_chain_sdk::multisig::{CosignatoryModification, MultisigModificationType};

const NODE_URL: &str = "http://bctestnet1.brimstone.xpxsirius.io:3000";

/// Future multiSig private key
const MULTI_SIG_PRIVATE_KEY: &str = "3B5550B5CB19C893694FC49B461CE489BF9588BE16DBE8DC29CF06338133DEE7";
...
async fn main() {
    ...
    let cosignatory_one = Account::from_private_key(COSIGNATORY_ONE_PRIVATE_KEY, network_type).unwrap();
    let cosignatory_two = Account::from_private_key(COSIGNATORY_TWO_PRIVATE_KEY, network_type).unwrap();
    let cosignatory_three = Account::from_private_key(COSIGNATORY_THREE_PRIVATE_KEY, network_type).unwrap();
