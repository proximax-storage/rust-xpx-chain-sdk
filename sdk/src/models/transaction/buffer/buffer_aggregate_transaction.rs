    ...
    pub mod buffers {
        ...
        impl<'a> AggregateTransactionBuffer<'a> {
            ...
            pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
                ...
                args: &'args AggregateTransactionBufferArgs<'args>) -> fb::WIPOffset<AggregateTransactionBuffer<'bldr>> {
            ...
            pub fn signature(&self) -> Option<&'a [u8]> {
                self._tab.get::<fb::ForwardsUOffset<fb::Vector<'a, u8>>>(AggregateTransactionBuffer::VT_SIGNATURE, None).map(|v| v.safe_slice())
            }
            #[inline]
            pub fn signer(&self) -> Option<&'a [u8]> {
                self._tab.get::<fb::ForwardsUOffset<fb::Vector<'a, u8>>>(AggregateTransactionBuffer::VT_SIGNER, None).map(|v| v.safe_slice())
            }
            #[inline]
            ...
            pub fn max_fee(&self) -> Option<fb::Vector<'a, u32>> {
                self._tab.get::<fb::ForwardsUOffset<fb::Vector<'a, u32>>>(AggregateTransactionBuffer::VT_MAXFEE, None)
            }
            #[inline]
            pub fn deadline(&self) -> Option<fb::Vector<'a, u32>> {
                self._tab.get::<fb::ForwardsUOffset<fb::Vector<'a, u32>>>(AggregateTransactionBuffer::VT_DEADLINE, None)
            }
            #[inline]
            ...
            pub fn transactions(&self) -> Option<&'a [u8]> {
                self._tab.get::<fb::ForwardsUOffset<fb::Vector<'a, u8>>>(AggregateTransactionBuffer::VT_TRANSACTIONS, None).map(|v| v.safe_slice())
            }
        }
        ...
        impl<'a: 'b, 'b> AggregateTransactionBufferBuilder<'a, 'b> {
            ...
            pub fn add_signature(&mut self, signature: fb::WIPOffset<fb::Vector<'b, u8>>) {
                self.fbb_.push_slot_always::<fb::WIPOffset<_>>(AggregateTransactionBuffer::VT_SIGNATURE, signature);
            }
            #[inline]
            pub fn add_signer(&mut self, signer: fb::WIPOffset<fb::Vector<'b, u8>>) {
                self.fbb_.push_slot_always::<fb::WIPOffset<_>>(AggregateTransactionBuffer::VT_SIGNER, signer);
            }
            #[inline]
            ...
            pub fn add_max_fee(&mut self, max_fee: fb::WIPOffset<fb::Vector<'b, u32>>) {
                self.fbb_.push_slot_always::<fb::WIPOffset<_>>(AggregateTransactionBuffer::VT_MAXFEE, max_fee);
            }
            #[inline]
            pub fn add_deadline(&mut self, deadline: fb::WIPOffset<fb::Vector<'b, u32>>) {
                self.fbb_.push_slot_always::<fb::WIPOffset<_>>(AggregateTransactionBuffer::VT_DEADLINE, deadline);
            }
            #[inline]
            ...
            pub fn add_transactions(&mut self, transactions: fb::WIPOffset<fb::Vector<'b, u8>>) {
                self.fbb_.push_slot_always::<fb::WIPOffset<_>>(AggregateTransactionBuffer::VT_TRANSACTIONS, transactions);
            }
            #[inline]
            pub fn new(_fbb: &'b mut fb::FlatBufferBuilder<'a>) -> AggregateTransactionBufferBuilder<'a, 'b> {
        ...
        #[inline]
        pub fn finish_size_prefixed_aggregate_transaction_buffer_buffer<'a, 'b>(fbb: &'b mut fb::FlatBufferBuilder<'a>, root: fb::WIPOffset<AggregateTransactionBuffer<'a>>) {
