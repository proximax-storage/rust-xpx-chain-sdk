    ...
    pub mod buffers {
        ...
        impl<'a> BlockchainUpgradeTransactionBuffer<'a> {
            ...
            pub fn size_(&self) -> u32 {
                self._tab.get::<u32>(BlockchainUpgradeTransactionBuffer::VT_SIZE_, Some(0)).unwrap()
            }
            #[inline]
            ...
            pub fn version(&self) -> u32 {
                self._tab.get::<u32>(BlockchainUpgradeTransactionBuffer::VT_VERSION, Some(0)).unwrap()
            }
            #[inline]
        ...
        impl<'a: 'b, 'b> BlockchainUpgradeTransactionBufferBuilder<'a, 'b> {
            ...
            pub fn add_version(&mut self, version: i32) {
                self.fbb_.push_slot::<u32>(BlockchainUpgradeTransactionBuffer::VT_VERSION, version, 0);
            }
            #[inline]
