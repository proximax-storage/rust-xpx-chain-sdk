    ...
    pub mod buffers {
        ...
        impl<'a> MessageBuffer<'a> {
            ...
            pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
                ...
                args: &'args MessageBufferArgs<'args>) -> fb::WIPOffset<MessageBuffer<'bldr>> {
            ...
            pub fn payload(&self) -> Option<&'a [u8]> {
                self._tab.get::<fb::ForwardsUOffset<fb::Vector<'a, u8>>>(MessageBuffer::VT_PAYLOAD, None).map(|v| v.safe_slice())
            }
        }
        ...
        impl<'a: 'b, 'b> MessageBufferBuilder<'a, 'b> {
            ...
            pub fn add_payload(&mut self, payload: fb::WIPOffset<fb::Vector<'b, u8>>) {
                self.fbb_.push_slot_always::<fb::WIPOffset<_>>(MessageBuffer::VT_PAYLOAD, payload);
            }
            #[inline]
        ...
        impl<'a> MosaicBuffer<'a> {
            ...
            pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
                _fbb: &'mut_bldr mut fb::FlatBufferBuilder<'bldr>,
                args: &'args MosaicBufferArgs<'args>) -> fb::WIPOffset<MosaicBuffer<'bldr>> {
            ...
            pub fn id(&self) -> Option<fb::Vector<'a, u32>> {
                self._tab.get::<fb::ForwardsUOffset<fb::Vector<'a, u32>>>(MosaicBuffer::VT_ID, None)
            }
            #[inline]
            pub fn amount(&self) -> Option<fb::Vector<'a, u32>> {
                self._tab.get::<fb::ForwardsUOffset<fb::Vector<'a, u32>>>(MosaicBuffer::VT_AMOUNT, None)
            }
        }
        ...
        impl<'a: 'b, 'b> MosaicBufferBuilder<'a, 'b> {
            ...
            pub fn add_id(&mut self, id: fb::WIPOffset<fb::Vector<'b, u32>>) {
                self.fbb_.push_slot_always::<fb::WIPOffset<_>>(MosaicBuffer::VT_ID, id);
            }
            #[inline]
            pub fn add_amount(&mut self, amount: fb::WIPOffset<fb::Vector<'b, u32>>) {
                self.fbb_.push_slot_always::<fb::WIPOffset<_>>(MosaicBuffer::VT_AMOUNT, amount);
            }
            #[inline]
        ...
        impl<'a> TransferTransactionBuffer<'a> {
            ...
            pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
                _fbb: &'mut_bldr mut fb::FlatBufferBuilder<'bldr>,
                args: &'args TransferTransactionBufferArgs<'args>) -> fb::WIPOffset<TransferTransactionBuffer<'bldr>> {
            ...
            pub fn signature(&self) -> Option<&'a [u8]> {
                self._tab.get::<fb::ForwardsUOffset<fb::Vector<'a, u8>>>(TransferTransactionBuffer::VT_SIGNATURE, None).map(|v| v.safe_slice())
            }
            #[inline]
            pub fn signer(&self) -> Option<&'a [u8]> {
                self._tab.get::<fb::ForwardsUOffset<fb::Vector<'a, u8>>>(TransferTransactionBuffer::VT_SIGNER, None).map(|v| v.safe_slice())
            }
            #[inline]
            ...
            pub fn max_fee(&self) -> Option<fb::Vector<'a, u32>> {
                self._tab.get::<fb::ForwardsUOffset<fb::Vector<'a, u32>>>(TransferTransactionBuffer::VT_MAXFEE, None)
            }
            #[inline]
            pub fn deadline(&self) -> Option<fb::Vector<'a, u32>> {
                self._tab.get::<fb::ForwardsUOffset<fb::Vector<'a, u32>>>(TransferTransactionBuffer::VT_DEADLINE, None)
            }
            #[inline]
            pub fn recipient(&self) -> Option<&'a [u8]> {
                self._tab.get::<fb::ForwardsUOffset<fb::Vector<'a, u8>>>(TransferTransactionBuffer::VT_RECIPIENT, None).map(|v| v.safe_slice())
            }
            #[inline]
            ...
            pub fn message(&self) -> Option<MessageBuffer<'a>> {
                self._tab.get::<fb::ForwardsUOffset<MessageBuffer<'a>>>(TransferTransactionBuffer::VT_MESSAGE, None)
            }
            #[inline]
            pub fn mosaics(&self) -> Option<fb::Vector<'a, fb::ForwardsUOffset<MosaicBuffer<'a>>>> {
                self._tab.get::<fb::ForwardsUOffset<fb::Vector<fb::ForwardsUOffset<MosaicBuffer<'a>>>>>(TransferTransactionBuffer::VT_MOSAICS, None)
            }
        }
        ...
        impl<'a: 'b, 'b> TransferTransactionBufferBuilder<'a, 'b> {
            ...
            pub fn add_signature(&mut self, signature: fb::WIPOffset<fb::Vector<'b, u8>>) {
                self.fbb_.push_slot_always::<fb::WIPOffset<_>>(TransferTransactionBuffer::VT_SIGNATURE, signature);
            }
            #[inline]
            pub fn add_signer(&mut self, signer: fb::WIPOffset<fb::Vector<'b, u8>>) {
                self.fbb_.push_slot_always::<fb::WIPOffset<_>>(TransferTransactionBuffer::VT_SIGNER, signer);
            }
            #[inline]
            ...
            pub fn add_max_fee(&mut self, max_fee: fb::WIPOffset<fb::Vector<'b, u32>>) {
                self.fbb_.push_slot_always::<fb::WIPOffset<_>>(TransferTransactionBuffer::VT_MAXFEE, max_fee);
            }
            #[inline]
            pub fn add_deadline(&mut self, deadline: fb::WIPOffset<fb::Vector<'b, u32>>) {
                self.fbb_.push_slot_always::<fb::WIPOffset<_>>(TransferTransactionBuffer::VT_DEADLINE, deadline);
            }
            #[inline]
            pub fn add_recipient(&mut self, recipient: fb::WIPOffset<fb::Vector<'b, u8>>) {
                self.fbb_.push_slot_always::<fb::WIPOffset<_>>(TransferTransactionBuffer::VT_RECIPIENT, recipient);
            }
            #[inline]
            ...
            pub fn add_message(&mut self, message: fb::WIPOffset<MessageBuffer<'b>>) {
                self.fbb_.push_slot_always::<fb::WIPOffset<MessageBuffer>>(TransferTransactionBuffer::VT_MESSAGE, message);
            }
            #[inline]
            pub fn add_mosaics(&mut self, mosaics: fb::WIPOffset<fb::Vector<'b, fb::ForwardsUOffset<MosaicBuffer<'b>>>>) {
                self.fbb_.push_slot_always::<fb::WIPOffset<_>>(TransferTransactionBuffer::VT_MOSAICS, mosaics);
            }
            #[inline]
            pub fn new(_fbb: &'b mut fb::FlatBufferBuilder<'a>) -> TransferTransactionBufferBuilder<'a, 'b> {
                let start = _fbb.start_table();
        ...
        #[inline]
        pub fn finish_size_prefixed_transfer_transaction_buffer_buffer<'a, 'b>(fbb: &'b mut fb::FlatBufferBuilder<'a>, root: fb::WIPOffset<TransferTransactionBuffer<'a>>) {
