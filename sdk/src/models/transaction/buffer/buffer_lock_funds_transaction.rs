    ...
    pub mod buffers {
        ...
        impl<'a> LockFundsTransactionBuffer<'a> {
            ...
            pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
                ...
                args: &'args LockFundsTransactionBufferArgs<'args>) -> fb::WIPOffset<LockFundsTransactionBuffer<'bldr>> {
            ...
            pub fn signature(&self) -> Option<&'a [u8]> {
                self._tab.get::<fb::ForwardsUOffset<fb::Vector<'a, u8>>>(LockFundsTransactionBuffer::VT_SIGNATURE, None).map(|v| v.safe_slice())
            }
            #[inline]
            pub fn signer(&self) -> Option<&'a [u8]> {
                self._tab.get::<fb::ForwardsUOffset<fb::Vector<'a, u8>>>(LockFundsTransactionBuffer::VT_SIGNER, None).map(|v| v.safe_slice())
            }
            #[inline]
            ...
            pub fn max_fee(&self) -> Option<fb::Vector<'a, u32>> {
                self._tab.get::<fb::ForwardsUOffset<fb::Vector<'a, u32>>>(LockFundsTransactionBuffer::VT_MAXFEE, None)
            }
            #[inline]
            pub fn deadline(&self) -> Option<fb::Vector<'a, u32>> {
                self._tab.get::<fb::ForwardsUOffset<fb::Vector<'a, u32>>>(LockFundsTransactionBuffer::VT_DEADLINE, None)
            }
            #[inline]
            pub fn mosaic_id(&self) -> Option<fb::Vector<'a, u32>> {
                self._tab.get::<fb::ForwardsUOffset<fb::Vector<'a, u32>>>(LockFundsTransactionBuffer::VT_MOSAICID, None)
            }
            #[inline]
            pub fn mosaic_amount(&self) -> Option<fb::Vector<'a, u32>> {
                self._tab.get::<fb::ForwardsUOffset<fb::Vector<'a, u32>>>(LockFundsTransactionBuffer::VT_MOSAICAMOUNT, None)
            }
            #[inline]
            pub fn duration(&self) -> Option<fb::Vector<'a, u32>> {
                self._tab.get::<fb::ForwardsUOffset<fb::Vector<'a, u32>>>(LockFundsTransactionBuffer::VT_DURATION, None)
            }
            #[inline]
            pub fn hash(&self) -> Option<&'a [u8]> {
                self._tab.get::<fb::ForwardsUOffset<fb::Vector<'a, u8>>>(LockFundsTransactionBuffer::VT_HASH, None).map(|v| v.safe_slice())
            }
        }
        ...
        impl<'a: 'b, 'b> LockFundsTransactionBufferBuilder<'a, 'b> {
            ...
            pub fn add_signature(&mut self, signature: fb::WIPOffset<fb::Vector<'b, u8>>) {
                self.fbb_.push_slot_always::<fb::WIPOffset<_>>(LockFundsTransactionBuffer::VT_SIGNATURE, signature);
            }
            #[inline]
            pub fn add_signer(&mut self, signer: fb::WIPOffset<fb::Vector<'b, u8>>) {
                self.fbb_.push_slot_always::<fb::WIPOffset<_>>(LockFundsTransactionBuffer::VT_SIGNER, signer);
            }
            #[inline]
            ...
            pub fn add_max_fee(&mut self, max_fee: fb::WIPOffset<fb::Vector<'b, u32>>) {
                self.fbb_.push_slot_always::<fb::WIPOffset<_>>(LockFundsTransactionBuffer::VT_MAXFEE, max_fee);
            }
            #[inline]
            pub fn add_deadline(&mut self, deadline: fb::WIPOffset<fb::Vector<'b, u32>>) {
                self.fbb_.push_slot_always::<fb::WIPOffset<_>>(LockFundsTransactionBuffer::VT_DEADLINE, deadline);
            }
            #[inline]
            pub fn add_mosaic_id(&mut self, mosaic_id: fb::WIPOffset<fb::Vector<'b, u32>>) {
                self.fbb_.push_slot_always::<fb::WIPOffset<_>>(LockFundsTransactionBuffer::VT_MOSAICID, mosaic_id);
            }
            #[inline]
            pub fn add_mosaic_amount(&mut self, mosaic_amount: fb::WIPOffset<fb::Vector<'b, u32>>) {
                self.fbb_.push_slot_always::<fb::WIPOffset<_>>(LockFundsTransactionBuffer::VT_MOSAICAMOUNT, mosaic_amount);
            }
            #[inline]
            pub fn add_duration(&mut self, duration: fb::WIPOffset<fb::Vector<'b, u32>>) {
                self.fbb_.push_slot_always::<fb::WIPOffset<_>>(LockFundsTransactionBuffer::VT_DURATION, duration);
            }
            #[inline]
            pub fn add_hash(&mut self, hash: fb::WIPOffset<fb::Vector<'b, u8>>) {
                self.fbb_.push_slot_always::<fb::WIPOffset<_>>(LockFundsTransactionBuffer::VT_HASH, hash);
            }
            #[inline]
            pub fn new(_fbb: &'b mut fb::FlatBufferBuilder<'a>) -> LockFundsTransactionBufferBuilder<'a, 'b> {
        ...
        #[inline]
        pub fn finish_size_prefixed_lock_funds_transaction_buffer_buffer<'a, 'b>(fbb: &'b mut fb::FlatBufferBuilder<'a>, root: fb::WIPOffset<LockFundsTransactionBuffer<'a>>) {
